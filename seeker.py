...
| (__| | | (_) \__ \__ \ |
 \___|_|  \___/|___/___/_|                                                                                                                                             
	...
	utils.print(f'{G}[>] {C}Created By   : {W}thewhiteh4t and edied by {R}crossi')
	utils.print(f'{G} |> {C}Community : {W}{comms_url} and {R}TEAM-VENOM')
	utils.print(f'{G}[>] {C}Version      : {W}{VERSION}\n')
	utils.print(f'{G}[*] {W}FIRST U HAVE TO OPEN ngrok in new tab by   {Y}"./ngrok http 8080" {W}\n' f'{G}[!] {W}If it asks for image write  {Y}"image.png"  {W}')
